...
class ChatBotModel:
    ...
    def cureOfDisease(self, plantName, diseaseName):
        cure = CureDB()
        matchingPagesContent, bol, total_tokens = cure.getCureDocs(
    ...
    def summarize(self, text):
        ...
        messages = [
            SystemMessage(
                ...
                what you can understand from this {text} to give the\
                    user the steps of cure from the management section
                """
            ),
